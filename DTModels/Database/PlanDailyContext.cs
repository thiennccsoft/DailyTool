        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ReportItems>(entity =>
            {
                ...
                entity.HasOne(d => d.Report)
                    .WithOne(p => p.ReportItems)
                    .HasForeignKey<ReportItems>(d => d.ReportId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ReportItems_Report_Plane");

                entity.HasOne(d => d.ReportNavigation)
                    .WithOne(p => p.ReportItems)
                    .HasForeignKey<ReportItems>(d => d.ReportId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ReportItems_User_Reports");
            });
